  ...
  ({ className, inset, children, ...props }, ref) => (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        // OPUX dark mode
        "dark:text-white/90 dark:focus:bg-white/10 dark:data-[state=open]:bg-white/10",
        inset && "pl-8",
        className
      )}
      {...props}
  ...
  ({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-[100] min-w-[8rem] rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-popover",
          // Dark mode: OPUX glass panel with solid fallback background
          "dark:glass-panel dark:bg-[hsl(216,28%,15%)] dark:border-white/10 dark:text-white/90",
  ...
  ({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        // OPUX dark mode
        "dark:text-white/90 dark:hover:bg-white/10 dark:hover:text-white dark:focus:bg-white/10 dark:focus:text-white",
        inset && "pl-8",
        className
      )}
      {...props}
  ...
  ({ className, children, checked, ...props }, ref) => (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        // OPUX dark mode
        "dark:text-white/90 dark:focus:bg-white/10 dark:focus:text-white",
        className
      )}
      checked={checked}
      {...props}
