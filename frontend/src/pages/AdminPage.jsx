...
export function AdminPage() {
  ...
  return (
    <ScrollArea className="h-full">
      <motion.div 
        className="max-w-7xl mx-auto p-3 sm:p-4 md:p-6 pb-8"
      ...
      >
        ...
        <motion.div 
          ...
          className={cn(
            "rounded-xl sm:rounded-2xl overflow-hidden mb-4 sm:mb-6",
            ...
            "shadow-[0_4px_16px_hsl(25,30%,25%,0.06),0_0_0_1px_hsl(30,25%,85%)]",
            "sm:shadow-[0_4px_16px_hsl(25,30%,25%,0.06),0_0_0_1px_hsl(30,25%,85%),0_0_0_3px_hsl(42,45%,97%),0_0_0_4px_hsl(30,20%,80%)]",
        ...
        >
          ...
          <div className="relative px-3 py-3 sm:px-6 sm:py-6 bg-gradient-to-br from-[hsl(25,50%,88%)]/50 via-[hsl(30,40%,92%)]/30 to-transparent dark:from-primary/10 dark:via-primary/5 dark:to-transparent border-b border-[hsl(30,25%,85%)] dark:border-white/10">
            {/* Subtle guilloche pattern overlay for light mode */}
            <div 
              className="absolute inset-0 opacity-[0.015] dark:opacity-0 pointer-events-none hidden sm:block"
              style={{
            ...
            <div className="flex items-center justify-between relative gap-2">
              <div className="flex items-center gap-2 sm:gap-4 min-w-0">
                <div className={cn(
                  "h-10 w-10 sm:h-14 sm:w-14 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0",
                  ...
                  <Shield className="h-5 w-5 sm:h-7 sm:w-7 text-[hsl(25,75%,45%)] dark:text-primary" />
                </div>
                <div className="min-w-0">
                  <h1 className={cn(
                    "text-base sm:text-2xl md:text-3xl font-bold font-serif text-[hsl(25,35%,18%)] dark:text-white truncate",
                  ...
                  <p className={cn(
                    "text-[10px] sm:text-sm text-[hsl(25,20%,45%)] dark:text-muted-foreground mt-0.5 truncate",
                    "[text-shadow:0_1px_0_rgba(255,255,255,0.5)] dark:[text-shadow:none]"
                  )}>
                    <span className="hidden sm:inline">Manage users, keys, gateways, and system settings</span>
                    <span className="sm:hidden">System management</span>
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                <Badge 
                  variant="outline" 
                  className="hidden md:flex items-center gap-1.5 px-3 py-1.5 bg-[hsl(145,35%,92%)] text-[hsl(145,45%,35%)] dark:bg-emerald-500/10 dark:text-emerald-400 border-[hsl(145,30%,75%)] dark:border-emerald-500/20"
                >
                ...
                <Button 
                  ...
                  className="h-8 w-8 sm:h-9 sm:w-auto sm:px-4 rounded-lg sm:rounded-xl"
                >
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <div className="overflow-x-auto -mx-2 px-2 sm:mx-0 sm:px-0 scrollbar-hide">
                <TabsList className={cn(
                  "inline-flex h-9 sm:h-12 items-center justify-start rounded-lg sm:rounded-xl p-0.5 sm:p-1 gap-0.5 sm:gap-1",
                  ...
                  {ADMIN_TABS.map((tab) => {
                    ...
                    return (
                      <TabsTrigger 
                        ...
                        value={tab.id} 
                        className={cn(
                          "flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-4 py-1.5 sm:py-2.5 rounded-md sm:rounded-lg text-xs sm:text-sm font-medium",
